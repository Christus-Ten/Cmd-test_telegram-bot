...
// Fonction de conversion en police mathématique sans-serif (𝖺𝖠𝗓𝖹)
function toMathSans(text) {
  const map = {
    // Minuscules a-z → 𝖺-𝗓 (U+1D5BA à U+1D5D4)
    ...
    // Majuscules A-Z → 𝖠-𝖹 (U+1D5A0 à U+1D5BA)
    ...
    // Chiffres 0-9 → 𝟢-𝟫 (U+1D7E0 à U+1D7E9) – optionnel
...
async function onStart({ bot, msg, chatId, args }) {
  ...
  try {
    ...
    // Transformer la réponse en police spéciale
